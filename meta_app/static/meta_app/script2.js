...
function Pychanger() {
  document.getElementById('div_to_change').innerHTML = 'בואו ללמוד את השפה של הגדולים! קורס Java איכותי ומעמיק, כניסה לנוח לעולם התכנות! צרו קשר<br><br><br><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Python_logo_and_wordmark.svg/2560px-Python_logo_and_wordmark.svg.png" style="width: 60%">';
...
function HTMLchanger() {
  document.getElementById('div_to_change').innerHTML = 'תמיד רציתם ללמוד פיתוח ועוצב אתרי אינטרנט? עכשיו זה הזמן! קורס אינטרנטי חד ומדוייק! צרו קשר<br><br><br><img src="https://www.freepnglogos.com/uploads/html5-logo-png/html5-logo-devextreme-multi-purpose-controls-html-javascript-3.png" style="width: 40%">';
  document.getElementById('div_to_change').style.fontSize = '40px'
  document.getElementById('div_to_change').style.textAlign = 'center';
